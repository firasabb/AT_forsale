        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.edit.tag', ['id' => $tag->id]) }}" class="edit-form-confirm">
                        {!! csrf_field() !!}
                        {!! method_field('PUT') !!}
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <input class="form-control enabled-disabled" type="text" name="name"  value="{{ $tag->name }}" placeholder="{{ __('main.name') }}" disabled/>
                                </div>
                            </div>
                            <div class="col">
                                <div>
                                    <input class="form-control enabled-disabled" type="text" name="url"  value="{{ $tag->url }}" placeholder="{{ __('main.URL') }}" disabled/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="block-button">
                ...
                <form action="{{ route('admin.delete.tag', ['id' => $tag->id]) }}" method="POST" class="delete-form-2 delete-form-confirm">
                    {!! csrf_field() !!}
                    {!! method_field('DELETE') !!}
