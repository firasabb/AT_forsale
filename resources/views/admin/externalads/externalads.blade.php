...
<div class="container">
        ...
        <div class="col search-col">
            <form method="post" action="{{ route('admin.search.externalads') }}">
                ...
                <div class="form-row" >
                    ...
                    <div class="col">
                        <input type='text' name='name' placeholder="Ad Name" class="form-control" value="{{ old('name') }}"/>
                    </div>
                    <div class="col-sm-1">
    ...
    <div class="row justify-content-center">
        <div class="col">
            <div class="card">
                <div class="card-header">External Ads</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="td-actions-btns">
                                        <a href="{{ route('admin.show.externalad', ['id' => $externalAd->id]) }}" class="btn btn-success">Show/Edit</a>
            ...
            <div class="block-button">
                <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#addModal">Add External Ad</button>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <form method="POST" action="{{ route('admin.add.externalad') }}">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Add External Ad</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <textarea class="form-control" name="body" placeholder="Ad body">{{ old('body') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
